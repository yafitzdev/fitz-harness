...
| Security | Hashed tokens and pairing codes, expiry/replay/revocation/disabled-user behavior, route grants, quotas, administrator boundaries, cross-user resource isolation, artifact headers, and secret redaction |
