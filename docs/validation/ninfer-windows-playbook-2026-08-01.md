...
| --- | --- | --- | --- |
| `qwen36-35b-a3b-mtp4-100k` | `default-agent` | `qwen3_6_35b_a3b.ninfer` | MTP4 |
...
- A clean host database exposed one playbook, two recipes, and the expected `default-agent` and `fast` routes.
