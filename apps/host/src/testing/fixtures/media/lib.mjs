...
// Shared helpers for the host's media provider fixture servers. `png1x1` and
// `wavMinimal` reproduce the canonical bytes of its media test double
...
// `fake-media-server.mjs`.

/** Same 1x1 RGBA PNG builder as src/testing/fake-media-adapter.ts. */
...
/** Same minimal WAV builder as the host's fake media adapter. */
