...
import { type FakeInstanceHandle } from "@fitz/inference-core/testing";
import type {
  LaunchSpec,
...
export interface FakeMediaEngineOptions {
   ...
   *  as the owned media fixture server does. */
  resultUrl?: string;
 ...
 *  observation style of `FakeEngineAdapter` (starts/submitted/cancelled/
 ...
 *  fixture server (`testing/fixtures/media/fake-media-server.mjs`) so a URL-fetched
